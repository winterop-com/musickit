...
//! `desktop/react/` (the design-v2 React prototype) for this wrapper.
//! The legacy vanilla-JS frontend lives at `desktop/frontend/` and is
//! still served by `desktop/tauri/` — kept side-by-side so the working
//! app stays untouched while the redesign iterates.
//!
